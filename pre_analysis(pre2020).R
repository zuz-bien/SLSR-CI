...
#write.csv(slsr, "/Users/Zuzanna_Bien/Desktop/ACF Public Health/Cognitive impairment in stroke/SLSR-CI/SLSR_raw_data/slsr(no exclusions).csv", row.names = FALSE)
...
#3.4 Calculate how many completed 3-month follow-up/ have a cog0.25 available 
slsr %>% filter(!is.na(dtint0.25) | (is.na(dtint0.25) & !is.na(cog0.25))) %>% nrow()

#n = 3425 


#3.5 Cognitive scores at 3 months available
slsr %>% filter(!is.na(cog0.25)) %>% nrow()  #2873
#--------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------
#Data including patients who died prior to 3mfu for the Sankey diagram 
