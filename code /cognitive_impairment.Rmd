...
#sum(!is.na(slsr$spechcur0.25)) - not currently available - requested additional data from Hatem 
...
#3128 are alive and 4793 are dead - so 22 are dead but we don't have a survival time 
